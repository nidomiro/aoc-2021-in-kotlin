...
class Tests : DescribeSpec({
    ...
    describe("part1") {
        ...
        it("Parses game correctly") {
            ...
            result shouldBe BingoGame(listOf(7,4,9,5,11,17,23,2,0,14,21,24,10,16,13,6,15,25,12,22,18,20,8,19,3,26,1),
            listOf(
                Board.fromString("""
                    22 13 17 11  0
                     8  2 23  4 24
        ...
        it("fulfills the given example") {
            ...
            result shouldBe Part1Result(3,188, 24,4512)
        }
    }
